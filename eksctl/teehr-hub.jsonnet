/*
    ...
    To use jsonnet to generate an eksctl configuration file from this, do:
        ...
        jsonnet teehr-hub.jsonnet > teehr-hub.eksctl.yaml
...

{
    ...
    metadata+: {
        name: "teehr-hub",
        region: clusterRegion,        version: '1.25'
    },
    ...
    //
    //    eksctl create addon --config-file=teehr-hub.eksctl.yaml
    //
    addons: [
        {
    ...
    nodeGroups: [
        ng {
            ...
            ssh: {
                publicKeyPath: 'ssh-keys/teehr-hub.key.pub'
            },
            instanceType: "r5.xlarge",
            minSize: 1,
            maxSize: 6,
